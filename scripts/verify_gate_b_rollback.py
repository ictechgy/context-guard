...
GEN9_BLESS_SUBJECT = "proof: establish Gate-B-free residual gen9 user settings permissions"
GEN9_B1_SUBJECT = "proof: reapply Gate-B nudge component gen9 user settings permissions"
GEN9_B2_SUBJECT = "proof: reapply Gate-B usage component gen9 user settings permissions"
GEN9_SHARED_SUBJECT = "proof: reapply Gate-B integration component gen9 user settings permissions"

GEN10_BLESS_SUBJECT = "proof: establish Gate-B-free residual gen10 doctor effective scope"
GEN10_B1_SUBJECT = "proof: reapply Gate-B nudge component gen10 doctor effective scope"
GEN10_B2_SUBJECT = "proof: reapply Gate-B usage component gen10 doctor effective scope"
GEN10_SHARED_SUBJECT = "proof: reapply Gate-B integration component gen10 doctor effective scope"

GEN11_BLESS_SUBJECT = "proof: establish Gate-B-free residual gen11 context efficiency roadmap"
GEN11_B1_SUBJECT = "proof: reapply Gate-B nudge component gen11 context efficiency roadmap"
...
GEN14_BLESS_SUBJECT = "proof: establish Gate-B-free residual gen14 OpenCode MCP schema"
GEN14_B1_SUBJECT = "proof: reapply Gate-B nudge component gen14 OpenCode MCP schema"
...
GEN16_BLESS_SUBJECT = "proof: establish Gate-B-free residual gen16 bash hook zero command authority"
GEN16_B1_SUBJECT = "proof: reapply Gate-B nudge component gen16 bash hook zero command authority"
GEN16_B2_SUBJECT = "proof: reapply Gate-B usage component gen16 bash hook zero command authority"
GEN16_SHARED_SUBJECT = "proof: reapply Gate-B integration component gen16 bash hook zero command authority"
GEN17_BLESS_SUBJECT = "proof: establish Gate-B-free residual gen17 tool result byte profile"
...
GEN19_BLESS_SUBJECT = "proof: establish Gate-B-free residual gen19 second byte profiler review"
GEN19_B1_SUBJECT = "proof: reapply Gate-B nudge component gen19 second byte profiler review"
GEN19_B2_SUBJECT = "proof: reapply Gate-B usage component gen19 second byte profiler review"
GEN19_SHARED_SUBJECT = "proof: reapply Gate-B integration component gen19 second byte profiler review"
GEN20_BLESS_SUBJECT = "proof: establish Gate-B-free residual gen20 table coverage disclosure"
...
# gen16 이 구속하는 통합 경로. `tests/test_context_guard_kit.py` 를 뺀다 —
# 3만 줄짜리 범용 테스트 모듈이라, ContextGuard 테스트를 건드리는 어떤 PR 이든
# 릴리스 proof 를 깨뜨렸다. 이는 runbook 이 명시한 "narrowing vector" 이며 해당
# 파일이 freeze 에서 영구 제외됨을 뜻한다. 어떤 Gate-B/잔여 마커도 이 경로를
...
GENERATIONS: tuple[Generation, ...] = (
    ...
    Generation(
        name="gen9",
        bless_subject=GEN9_BLESS_SUBJECT,
        b1_subject=GEN9_B1_SUBJECT,
        b2_subject=GEN9_B2_SUBJECT,
        shared_subject=GEN9_SHARED_SUBJECT,
        b1_paths=B1_PATHS,
        b2_paths=B2_PATHS,
        shared_paths=SHARED_INTEGRATION_PATHS,
        residual_markers=GEN1_RESIDUAL_MARKERS,
    ...
    Generation(
        name="gen10",
        bless_subject=GEN10_BLESS_SUBJECT,
        b1_subject=GEN10_B1_SUBJECT,
        b2_subject=GEN10_B2_SUBJECT,
        shared_subject=GEN10_SHARED_SUBJECT,
        b1_paths=B1_PATHS,
        b2_paths=B2_PATHS,
        shared_paths=SHARED_INTEGRATION_PATHS,
        residual_markers=GEN1_RESIDUAL_MARKERS,
    ...
    Generation(
        name="gen11",
        bless_subject=GEN11_BLESS_SUBJECT,
        b1_subject=GEN11_B1_SUBJECT,
        b2_subject=GEN11_B2_SUBJECT,
        shared_subject=GEN11_SHARED_SUBJECT,
        b1_paths=B1_PATHS,
        b2_paths=B2_PATHS,
        shared_paths=SHARED_INTEGRATION_PATHS,
        residual_markers=GEN1_RESIDUAL_MARKERS,
    ...
    Generation(
        name="gen14",
        bless_subject=GEN14_BLESS_SUBJECT,
        b1_subject=GEN14_B1_SUBJECT,
        b2_subject=GEN14_B2_SUBJECT,
        shared_subject=GEN14_SHARED_SUBJECT,
        b1_paths=B1_PATHS,
        b2_paths=B2_PATHS,
        shared_paths=SHARED_INTEGRATION_PATHS,
        residual_markers=GEN1_RESIDUAL_MARKERS,
    ...
    Generation(
        name="gen16",
        bless_subject=GEN16_BLESS_SUBJECT,
        b1_subject=GEN16_B1_SUBJECT,
        b2_subject=GEN16_B2_SUBJECT,
        shared_subject=GEN16_SHARED_SUBJECT,
        b1_paths=B1_PATHS,
        b2_paths=B2_PATHS,
    ...
    # gen17: transcript 의 tool_result 바이트 프로파일 절이 B2 의
    # `claude_transcript_cost_audit.py` 와 그 패키지 미러를 바꾼다. 두 경로 모두 동결
    # 구성요소이고, 새 바이너리로 우회하는 길도 shared-integration 의
    # `context_guard_commands.py` 를 거치므로 freeze 가 실제 blocker 다(runbook 1단계).
    # 경로 집합을 좁히지 않는다 — Gate-B 마커 `transcript_usage_reducer` 의 소유 경로가
    # 이 파일이라, 좁히면 마커까지 freeze 밖으로 나간다. 마커 리터럴은 HEAD 에 그대로
    # 남아 있으므로 존재 검사와 전방 이월은 그대로 유지된다.
    Generation(
        name="gen17",
        bless_subject=GEN17_BLESS_SUBJECT,
        b1_subject=GEN17_B1_SUBJECT,
        b2_subject=GEN17_B2_SUBJECT,
        shared_subject=GEN17_SHARED_SUBJECT,
        b1_paths=B1_PATHS,
        b2_paths=B2_PATHS,
        shared_paths=GEN16_SHARED_INTEGRATION_PATHS,
        residual_markers=GEN1_RESIDUAL_MARKERS,
    ...
    # gen19: 두 번째 리뷰 후속(확장자 allowlist, sentinel 넘침 면제, 블록 단위 클래스
    # 귀속)이 다시 B2 의 audit 과 그 미러를 바꾼다. gen17/gen18 과 같은 이유로 freeze 가
    # 실제 blocker 이고, 마커 소유 경로가 이 파일이라 좁히지 않는다.
    Generation(
        name="gen19",
        bless_subject=GEN19_BLESS_SUBJECT,
        b1_subject=GEN19_B1_SUBJECT,
        b2_subject=GEN19_B2_SUBJECT,
        shared_subject=GEN19_SHARED_SUBJECT,
        b1_paths=B1_PATHS,
        b2_paths=B2_PATHS,
        shared_paths=GEN16_SHARED_INTEGRATION_PATHS,
        residual_markers=GEN1_RESIDUAL_MARKERS,
    ...
    # gen20: 표 절단 공개와 파일 경계 신호 이동이 다시 B2 의
    # claude_transcript_cost_audit.py 와 그 미러를 바꾼다. gen17 이후와 같은 이유로
    # freeze 가 실제 blocker 이고, 같은 이유로 경로 집합을 좁히지 않는다 - Gate-B
    # 마커 transcript_usage_reducer 의 소유 경로가 이 파일이다.
    Generation(
        name="gen20",
        bless_subject=GEN20_BLESS_SUBJECT,
        b1_subject=GEN20_B1_SUBJECT,
        b2_subject=GEN20_B2_SUBJECT,
        shared_subject=GEN20_SHARED_SUBJECT,
        b1_paths=B1_PATHS,
        b2_paths=B2_PATHS,
        shared_paths=GEN16_SHARED_INTEGRATION_PATHS,
        residual_markers=GEN1_RESIDUAL_MARKERS,
