...
def load_module(rel, name, extra_sys_path=()):
    ...
    return module
module = load_module("src/limits.py", "s003_limits")
if getattr(module, "MAX_ITEMS", None) != 10:
    fail("MAX_ITEMS is not the documented maximum 10")
if getattr(module, "MIN_ITEMS", None) != 1:
