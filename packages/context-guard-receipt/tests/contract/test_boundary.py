    ...
    def test_post_stage2_hash_exemptions_are_exact_and_bounded(self) -> None:
        ...
        self.assertEqual(
            guard.POST_STAGE2_PROTECTED_SHA256,
            {
                ...
                "context-guard-kit/benchmark_runner.py": "f14b87fb2fcab1a641f527d27fd7b7a9d64b639950f574283c2ce4f2deba2d54",
                ...
                "plugins/context-guard/bin/context-guard-bench": "f14b87fb2fcab1a641f527d27fd7b7a9d64b639950f574283c2ce4f2deba2d54",
