#!/usr/bin/env python3
"""Explicit production launcher for the pinned V4 live gate.
...
EXPECTED_RUNNER_SHA256 = "7510b42e0e82ecbe26817f2f0cbe145a1b905c366e1f42da406d22a9b247bd92"
EXPECTED_CONTRACT_SHA256 = "4b20802a931ef5d7717b7e554544390f09c74f135733209bcb83b5b972b290fa"
EXPECTED_CORE_COMMIT = "afdbeb539c0a147b83b1bacefe9cbd786e9990d9"
...
def _load_runner():
    path = V4 / "live_runner.py"
    raw = _read_bound(path, EXPECTED_RUNNER_SHA256)
    spec = importlib.util.spec_from_file_location("contextguard_v4_live_runner", path)
...
def _verify_core_commit(repo_root: Path) -> None:
    ...
    try:
        ...
        expected_root = V4.parents[3].resolve(strict=True)
    except OSError:
        raise RuntimeError("bound core unavailable") from None
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        contract_path = V4 / "live-contract.json"
