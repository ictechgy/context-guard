...
RECEIPT_COMPANION_INVENTORY = [
    ...
    {'file_type': 'regular', 'mode': '0644', 'path': 'packages/context-guard-receipt/package-files.json', 'sha256': '295e9ed3dcbc8b21881ca3d9322172677b5c6ec35398c7cfa33908b0c9cd71fa'},
