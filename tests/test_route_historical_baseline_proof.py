...
class RouteHistoricalBaselineProofTests(unittest.TestCase):
    ...
    def test_cli_executes_complete_pinned_deny_to_allow_inventory(self) -> None:
        ...
        self.assertEqual(proof["relaxation_case_count"], 73)
        self.assertEqual(proof["deny_to_allow_case_count"], 70)
        self.assertEqual(proof["baseline_reason_counts"], {"route_policy_denied": 70})
    ...
    def test_proof_binds_observations_to_tree_keyed_cache(self) -> None:
        ...
        self.assertEqual(proof.get("baseline_cache_case_count"), 70)
        self.assertEqual(
            proof.get("baseline_cache_sha256"),
            "d74c613b830451122619696e04cc64e287d1c6d101645c78a6382065bd945fd7",
        )
