...
class GateBGenerationRecordTests(SyntheticGenerationHelpers, unittest.TestCase):
    ...
    def test_shipped_generations_pin_s006_gen2_s007_gen3_through_gen22(self) -> None:
        """운영 레코드는 gen2~gen22을 append-only 순서로 보존한다."""
        self.assertEqual(
        ...
        (
            ...
            gen11, gen12, gen13, gen14, gen15, gen16, gen17, gen18, gen19, gen20, gen21, gen22,
        ...
        self.assertEqual(gen8.b1_paths, rollback_proof.B1_PATHS)
        self.assertEqual(gen8.b2_paths, rollback_proof.B2_PATHS)
        self.assertEqual(
            gen8.shared_paths,
            rollback_proof.SHARED_INTEGRATION_PATHS,
        )
        self.assertEqual(gen8.residual_markers, rollback_proof.GEN1_RESIDUAL_MARKERS)
        self.assertEqual(gen8.gate_b_markers, rollback_proof.GEN1_GATE_B_MARKERS)
        self.assertEqual(
            gen8.residual_edits,
            frozenset(
                {
        ...
        gen8_subjects = (
            rollback_proof.GEN8_BLESS_SUBJECT,
            rollback_proof.GEN8_B1_SUBJECT,
            rollback_proof.GEN8_B2_SUBJECT,
            rollback_proof.GEN8_SHARED_SUBJECT,
        )
        self.assertEqual(
            gen8_subjects,
            (
                "proof: establish Gate-B-free residual gen8 home settings safety",
                "proof: reapply Gate-B nudge component gen8 home settings safety",
                "proof: reapply Gate-B usage component gen8 home settings safety",
                "proof: reapply Gate-B integration component gen8 home settings safety",
            ),
        )
        self.assertEqual(
            (
        ...
        self.assertEqual(gen9.b1_paths, rollback_proof.B1_PATHS)
        self.assertEqual(gen9.b2_paths, rollback_proof.B2_PATHS)
        self.assertEqual(
            gen9.shared_paths,
            rollback_proof.SHARED_INTEGRATION_PATHS,
        )
        self.assertEqual(gen9.residual_markers, rollback_proof.GEN1_RESIDUAL_MARKERS)
        self.assertEqual(gen9.gate_b_markers, rollback_proof.GEN1_GATE_B_MARKERS)
        self.assertEqual(
            gen9.residual_edits,
            frozenset(
                {
        ...
        gen9_subjects = (
            rollback_proof.GEN9_BLESS_SUBJECT,
            rollback_proof.GEN9_B1_SUBJECT,
            rollback_proof.GEN9_B2_SUBJECT,
            rollback_proof.GEN9_SHARED_SUBJECT,
        )
        self.assertEqual(
            gen9_subjects,
            (
                "proof: establish Gate-B-free residual gen9 user settings permissions",
                "proof: reapply Gate-B nudge component gen9 user settings permissions",
                "proof: reapply Gate-B usage component gen9 user settings permissions",
                "proof: reapply Gate-B integration component gen9 user settings permissions",
            ),
        )
        self.assertEqual(
            (
        ...
        self.assertEqual(gen11.b1_paths, rollback_proof.B1_PATHS)
        self.assertEqual(gen11.b2_paths, rollback_proof.B2_PATHS)
        self.assertEqual(
            gen11.shared_paths,
            rollback_proof.SHARED_INTEGRATION_PATHS,
        )
        self.assertEqual(gen11.residual_markers, rollback_proof.GEN1_RESIDUAL_MARKERS)
        self.assertEqual(gen11.gate_b_markers, rollback_proof.GEN1_GATE_B_MARKERS)
        self.assertEqual(
            gen11.residual_edits,
            frozenset(
                {
        ...
        gen11_subjects = (
            rollback_proof.GEN11_BLESS_SUBJECT,
            rollback_proof.GEN11_B1_SUBJECT,
            rollback_proof.GEN11_B2_SUBJECT,
            rollback_proof.GEN11_SHARED_SUBJECT,
        )
        self.assertEqual(
            gen11_subjects,
            (
                "proof: establish Gate-B-free residual gen11 context efficiency roadmap",
                "proof: reapply Gate-B nudge component gen11 context efficiency roadmap",
                "proof: reapply Gate-B usage component gen11 context efficiency roadmap",
                "proof: reapply Gate-B integration component gen11 context efficiency roadmap",
            ),
        )
        self.assertEqual(
            (
                ...
                gen11.b1_subject,
                gen11.b2_subject,
                gen11.shared_subject,
            ),
            gen11_subjects,
        )

        self.assertEqual(gen12.b1_paths, rollback_proof.B1_PATHS)
        self.assertEqual(gen12.b2_paths, rollback_proof.B2_PATHS)
        self.assertEqual(
            gen12.shared_paths,
            rollback_proof.SHARED_INTEGRATION_PATHS,
        )
        self.assertEqual(gen12.residual_markers, rollback_proof.GEN1_RESIDUAL_MARKERS)
        self.assertEqual(gen12.gate_b_markers, rollback_proof.GEN1_GATE_B_MARKERS)
        self.assertEqual(gen12.residual_edits, frozenset())
        gen12_subjects = (
            rollback_proof.GEN12_BLESS_SUBJECT,
            rollback_proof.GEN12_B1_SUBJECT,
            rollback_proof.GEN12_B2_SUBJECT,
            rollback_proof.GEN12_SHARED_SUBJECT,
        )
        self.assertEqual(
            gen12_subjects,
            (
                "proof: establish Gate-B-free residual gen12 wrapper no-follow hardening",
                "proof: reapply Gate-B nudge component gen12 wrapper no-follow hardening",
                "proof: reapply Gate-B usage component gen12 wrapper no-follow hardening",
                "proof: reapply Gate-B integration component gen12 wrapper no-follow hardening",
            ),
        )
        self.assertEqual(
            (
    ...
    def test_narrowed_paths_report_names_every_dropped_path(self) -> None:
        ...
        self.assertEqual(
            report,
            {
                ...
                "gen20": ["tests/test_context_guard_kit.py"],
