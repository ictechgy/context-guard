...
class GateBGenerationRecordTests(SyntheticGenerationHelpers, unittest.TestCase):
    ...
    def test_shipped_generations_pin_s006_gen2_s007_gen3_gen4_gen5_and_gen6(self) -> None:
        """운영 레코드는 gen2~gen6를 append-only 순서로 보존한다."""
        self.assertEqual(
            tuple(generation.name for generation in rollback_proof.GENERATIONS),
            ("gen1", "gen2", "gen3", "gen4", "gen5", "gen6"),
        )
        gen1, gen2, gen3, gen4, gen5, gen6 = rollback_proof.GENERATIONS
