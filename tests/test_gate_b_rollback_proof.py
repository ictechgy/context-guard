...
class GateBGenerationRecordTests(SyntheticGenerationHelpers, unittest.TestCase):
    ...
    def test_shipped_generations_pin_s006_gen2_s007_gen3_gen4_gen5_gen6_gen7_and_gen8(self) -> None:
        """운영 레코드는 gen2~gen8을 append-only 순서로 보존한다."""
        self.assertEqual(
            tuple(generation.name for generation in rollback_proof.GENERATIONS),
            ("gen1", "gen2", "gen3", "gen4", "gen5", "gen6", "gen7", "gen8"),
        )
        gen1, gen2, gen3, gen4, gen5, gen6, gen7, gen8 = rollback_proof.GENERATIONS
        ...
        self.assertEqual(gen8.shared_paths, rollback_proof.SHARED_INTEGRATION_PATHS)
        ...
        self.assertEqual(
            gen8_subjects,
            (
                "proof: establish Gate-B-free residual gen8 modular pack manifests",
                "proof: reapply Gate-B nudge component gen8 modular pack manifests",
                "proof: reapply Gate-B usage component gen8 modular pack manifests",
                "proof: reapply Gate-B integration component gen8 modular pack manifests",
            ),
        )
