...
> **2026-09-08 개발 중단.** 유지관리자는 추가 개발을 중단하기로 결정했으며 새
> 설치를 권장하지 않습니다. 일반적인 토큰 또는 비용 절감은 입증되지 않았습니다.
> 제품 자체의 오버헤드가 관측되었고 일부 작업량에서는 입력량 증가도 관측되어 이
> 결정을 내렸습니다. 이는 모든 환경에서 비용이 증가하거나 무효하다는 뜻은
> 아닙니다. 기존 소스 코드와 연구 자료는 참고용으로 보존됩니다.
